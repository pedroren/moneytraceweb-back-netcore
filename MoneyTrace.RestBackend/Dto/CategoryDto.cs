...
public static class CategoryDtoExtensions
{
    ...
    public static UpdateSubCategoryCommand ToUpdateSubCommand(this SubCategoryDto subCategory)
    {
        return new UpdateSubCategoryCommand(subCategory.Id, subCategory.Name, subCategory.IsEnabled);
    }
