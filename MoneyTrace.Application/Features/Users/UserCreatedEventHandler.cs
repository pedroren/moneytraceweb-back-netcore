...
internal sealed class UserCreatedEventHandler (IMediator mediator): INotificationHandler<DomainEventNotification<UserCreatedEvent>>
{
  ...
  {
    var category1 = new CreateCategoryCommand(domainEvent.Item.Id, "Food", CategoryType.Expense);
    var task1 = mediator.Send(category1, cancellationToken);
    var category2 = new CreateCategoryCommand(domainEvent.Item.Id, "Entertainment", CategoryType.Expense);
    var task2 = mediator.Send(category2, cancellationToken);
    var category3 = new CreateCategoryCommand(domainEvent.Item.Id, "Salary", CategoryType.Income);
    var task3 = mediator.Send(category3, cancellationToken);
    var category4 = new CreateCategoryCommand(domainEvent.Item.Id, "Utilities", CategoryType.Expense);
    var task4 = mediator.Send(category4, cancellationToken);
    var category5 = new CreateCategoryCommand(domainEvent.Item.Id, "Rent", CategoryType.Expense);
    var task5 = mediator.Send(category5, cancellationToken);
    var category6 = new CreateCategoryCommand(domainEvent.Item.Id, "Other", CategoryType.Expense);
    var task6 = mediator.Send(category6, cancellationToken);
    var category7 = new CreateCategoryCommand(domainEvent.Item.Id, "Other Income", CategoryType.Income);
